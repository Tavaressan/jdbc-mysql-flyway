...
//                var birthday = isNull(resultSet.getTimestamp("birthday").toInstant()) ? null :
//                        OffsetDateTime.ofInstant(
//                                resultSet.getTimestamp("birthday").toInstant(),UTC);
//
//                var oldBirthday = isNull(resultSet.getTimestamp("old_birthday").toInstant()) ? null :
//                        OffsetDateTime.ofInstant(
